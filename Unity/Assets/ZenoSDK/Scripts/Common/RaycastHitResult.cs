...
namespace ZenoSDK
{
    ...
    {
        // Raycast from the screen center to detected plane in the zone. Cursor texture will align with the plane surface.
        Plane = 0,

        // Raycast from the screen center to meshes in the zone. Cursor texture will align with the terrain of the mesh it hit.
        Mesh = 1,
    }
