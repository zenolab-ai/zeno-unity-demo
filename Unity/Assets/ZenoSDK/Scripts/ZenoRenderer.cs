...
namespace ZenoSDK
{
    // Abstract class as interface that Zeno core system will be calling to render the space or canvas.
    // Developer can extend it to customize the visualization when working with AR oprations provided by the system.
    public abstract class ZenoRenderer : MonoBehaviour
    {
        ...
        // Core system sends updated zone origin offset coordinate from localizar.
        public abstract void UpdateZoneOriginOffset(Pose originOffset);
        ...
        // Core system sends registered images count of the zone.
        ...
        public abstract RaycastHitResult? RenderRaycastCursor(Matrix4x4 localToZoneTransform);
        ...
        public abstract ZoneStreamRenderable GetStreamRenderable();
